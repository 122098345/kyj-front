  ...
  <div class="content">
    <el-form :model="queryParams" ref="queryForm" :inline="true">
      <el-form-item label="年份" prop="filterTime">
        <el-date-picker v-model="queryParams.year" type="year" size="small" align="center" placeholder="请选择年份" value-format="yyyy" @change="dateSelectChanged"/>
      </el-form-item>
...
export default {
  ...
  methods:{
    // 日期选择改变时
    dateSelectChanged(val){
      if(val){
        this.queryParams.startDate=val+'-01'
        this.queryParams.endDate=val+'-12'
      }else{
