<template>
  <div class="content">
    <el-form :model="queryParams" ref="queryForm" :inline="true">
      <el-form-item label="日期" prop="filterTime">
        <el-date-picker v-model="queryParams.filterTime" type="daterange" size="small" align="center" range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期"/>
      </el-form-item>
  ...
  methods:{
    ...
    handleQuery(){
      if(this.queryParams.filterTime && this.queryParams.filterTime.length === 2){
        this.queryParams.startDate= moment(this.queryParams.filterTime[0]).format('YYYY-MM-DD');
        this.queryParams.endDate=moment(this.queryParams.filterTime[1]).format('YYYY-MM-DD');
      }else{
